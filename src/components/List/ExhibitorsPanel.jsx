              ...
              {isViewOnly ? (
                <div className="view-only-details">
                  ...
                  <div className="details-grid">
                    ...
                    <p>
                      <strong>MOBILE:</strong> <span>{formData.mobile}</span>
                    </p>
                    <p>
                  ...
                  {stallList.map((stall, i) => (
                    ...
                    >
                      <p>
                        <strong>STALL NUMBER:</strong> {stall.stall_number}
                      </p>
                      <p>
                        <strong>STALL CATEGORY:</strong> {stall.stall_category}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>DISCOUNT:</strong> {stall.discount_percent}%
                      </p>
                      <p>
                        ...
                        <div className="stalls-form-row">
                                  ...
                                  <div className="field">
                                    ...
                                    <select
                                      ...
                                      onChange={(e) => {
                                        ...
                                        if (
                                          selected.startsWith("Shell Scheme")
                                        ) {
                                        ...
                                        if (
                                          ...
                                          let price = 0;
                                          if (formData.currency === "Rupees")
                                            price = matchedCategory.rupees;
                                          else if (
                                            formData.currency === "Dollar"
                                          )
                                            price = matchedCategory.dollar;
                                          else if (formData.currency === "Euro")
                                            price = matchedCategory.euro;

                                          setFormData((prev) => ({
                                            ...prev,
                                            stall_category: selected,
                                            stall_price: parseFloat(price) || 0,
                                          }));
                                        } else {
                                          setFormData((prev) => ({
                                            ...prev,
                          ...
                          <div className="billing-details">
                            ...
                            <div className="billing-row">
                              ...
                              <strong>{formData.stall_number || "-"}</strong>
                            </div>
                            <div className="billing-row">
                              <span>Hall Number:</span>
                              <strong>{formData.hall_number || "-"}</strong>
                            </div>
                            <div className="billing-row">
                              <span>Stall Category:</span>
                              <strong>{formData.stall_category || "-"}</strong>
                            </div>
                            <div className="billing-row">
                              <span>Stall Area:</span>
                              <strong>{formData.stall_area || "-"}</strong>
                            </div>
                            <div className="billing-row">
                              ...
                              parseFloat(formData.discount) > 0 && (
                                <>
                                  <div className="billing-row">
                                    ...
                                    <strong>
                                      {customRound(formData.discounted_amount)}{" "}
                                      {formData.currency}
                                    </strong>
                                  </div>
                                  <hr />
                                    ...
                                    <tr key={rowIndex}>
                                      ...
                                      <td className="stall-action-buttons">
                                        ...
                                        <button
                                          ...
                                          onClick={() =>
                                            handleDeleteExhibitorStall(rowIndex)
                                          }
                                        >
                                          <FontAwesomeIcon icon={faTrash} />
                                        </button>
                      ...
                      <>
                        ...
                        <div className="power-requirement-wrapper">
                          ...
                          <div className="power-requirement-instruction-box">
                            ...
                            <ul>
                              <li>
                                Power requirements for setup days and exhibition
                                days must be submitted separately.
                              </li>
                              <li>
                                Power will be arranged as per the requirement
                                form. Requests made after 28th February 2026 may
                                incur additional charges.
                              </li>
                              <li>
                                If unsure of your needs, please consult your
                                fabricator for accurate details.
                              </li>
                              <li>
                                Kindly ensure your contractor uses quality,
                                thick wiring. Additional charges may apply if
                                power usage exceeds the amount ordered.
                              </li>
                        ...
                        <div className="power-requirement-below-section">
                          ...
                          <div className="power-requirement-billing">
                            ...
                            <div className="power-requirement-stalls-forms-group">
                              <span className="power-label">Total Price:</span>
                              <strong>{totalPrice.toFixed(2)} ₹</strong>
                            </div>
                            ...
                            {formData.state?.toLowerCase() === "delhi" ? (
                              ...
                              <div className="power-requirement-stalls-forms-group">
                                <span className="power-label">IGST (18%):</span>
                                <strong>{igst.toFixed(2)} ₹</strong>
                              </div>
                            )}

                            <div className="power-requirement-stalls-forms-group total">
                              <span className="power-label">Grand Total:</span>
                              <strong>{grandTotal.toFixed(2)} ₹</strong>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="badge-flex-container">
                          ...
                          <div className="badge-left">
                            <div className="badges-instruction-box">
                              ...
                              <div className="instruction-text">
                                ...
                                complimentary badge
                                {formData.free_badges === 1 ? "" : "s"} for the
                                exhibition.
                                <br />
                                <br />
                                Additional badges can be requested at a cost of
                                ₹100 per badge. However, any badge requests made
                                after <strong>20th March 2026</strong> will be
                                charged at ₹200 per badge.
                                <br />
                                <br />
                                We kindly request you to order only the number
                                of badges you truly need, as issuing excess
                                badges poses a potential security risk.
                                <br />
                                <br />
                                ...
                                <div className="badge-box">
                                  ...
                                  {!isViewOnly && (
                                    <button
                                      type="button"
                                      className="badge-update-btn"
                                      onClick={handleExhibitorBadgesSubmit} // old function
                                    >
                                      Update Extra Badges
                                    </button>
                                  )}
                          ...
                          {parseInt(formData.extra_badges, 10) > 0 &&
                            (() => {
                              ...
                              const rate =
                                new Date() > new Date("2026-03-21") ? 200 : 100; // Corrected date to '2026-03-20'
                              const total = count * rate;
                      ...
                      <>
                        <div className="appointed-contractor-section">
                          <div className="left-column">
                            <div className="contractor-instruction-box">
                              ...
                              <p>
                                ...
                                deadline. ID badges must be collected prior to
                                exhibition day. Ensure proper documentation is
                                uploaded in the portal. Contractor undertaking
                                form is mandatory. Follow the venue safety and
                                conduct guidelines strictly.
                              </p>
                          ...
                          <div className="contractor-actions">
                            ...
                            <p className="booth-design-instruction">
                              Please upload a high-quality image of your booth
                              design. The image should clearly show the layout
                              and structural details.
                              <br />
                              <strong>
                                Recommended dimensions:
                              </strong> Width: <code>1200px</code>, Height:{" "}
                              <code>800px</code>.
                              <br />
                              Accepted formats: <code>.jpg</code>,{" "}
                              <code>.png</code>, <code>.pdf</code>. Maximum file
                              size: <code>5MB</code>.
                            </p>
                            ...
                            >
                              ...
                              <div className="appointedcontractor-modal-content">
                                <p className="appointedcontractor-instruction-text">
                                  FOR SMOOTH AND QUICK FUNCTIONALITY PLEASE
                                  FORWARD THIS REGISTRATION FORM TO YOUR
                                  CONTRACTOR AND ASK THEM TO FILL THE FORM AND
                                ...
                                <div className="appointedcontractor-mail-preview">
                                  <h4>📧 Mail Preview</h4>
                                  <p>
                                    <strong>To:</strong> INOPTICS@GMAIL.COM
                                  </p>
                                  <p>
                                  ...
                                  <p>
                                    <strong>Body:</strong> Dear Team, <br />{" "}
                                    Please find attached the contractor
                                    registration form for approval.
                                  </p>
                                </div>
                        ...
                        {showContractorOverlay && (
                          <div
                            ...
                            onClick={() => setShowContractorOverlay(false)}
                          >
                            <div
                            ...
                            >
                              ...
                              <div className="contractor-instruction-box-modal">
                                ...
                                <ol>
                                  <li>
                                    Click here to{" "}
                                    <strong>Send the Undertaking Form</strong>{" "}
                                    to your selected contractor.
                                  </li>
                                  <li>
                                    FOR SMOOTH AND QUICK FUNCTIONALITY PLEASE
                                    FORWARD THIS UNDERTAKING FORM TO YOUR
                                    CONTRACTOR AND ASK THEM TO FILL THE FORM AND
                                    THEN SEND THE FORM TO{" "}
                                    <strong>INOPTICS@GMAIL.COM</strong>
                                  </li>
                                  <li>
                                    ...
                                    <br /> ➤ Bare space: from 25/03/2026, 4:00
                                    PM to 27/03/2026, 4:00 PM
                                    <br /> ➤ Shell scheme: from 26/03/2026, 4:00
                                    PM to 27/03/2026, 4:00 PM
                                    <br />
                                    <br />
                                    <strong>Dismantling:</strong>
                                    <br /> ➤ Bare space: from 30/03/2026, 4:30
                                    PM to 30/03/2026, 12:00 MIDNIGHT
                                    <br /> ➤ Shell scheme: from 30/03/2026, 4:30
                                    PM to 30/03/2026, 9:00 PM
                                  </li>
                                  <li>
                                    Booth Design is also mandatory to be
                                    uploaded for approval with proper
                                    instruction given in the Booth Design space.
                                  </li>
                                  <li>
                                    After receiving the form, read it carefully.
                                    It should be filled by the contractor and
                                    then e-mail that form like this:
                                  </li>
                                </ol>
                              ...
                              >
                                ...
                                {lockState.is_locked === 1 && (
                                  <button
                                    ...
                                    onClick={() =>
                                      handleAdminUnlock(formData.company_name)
                                    }
                                  >
                                    Unlock
                                  </button>
                              ...
                              {formData.state?.toLowerCase() === "delhi" ? (
                                <>
                                  ...
                                  >
                                    ...
                                    <span>
                                      ₹
                                      {furnitureBilling.cgst?.toFixed(2) ||
                                        "0.00"}
                                    </span>
                                  </div>
                                  <div
                                  ...
                                  >
                                    ...
                                    <span>
                                      ₹
                                      {furnitureBilling.sgst?.toFixed(2) ||
                                        "0.00"}
                                    </span>
                                  </div>
                                </>
                            ...
                            {stallList.length > 1 ? (
                              ...
                              <div className="payment-details-label-group">
                                ...
                                <label>
                                  ...
                                  {(() => {
                                    const areaValue = stallList[0]?.stall_area;
                                    if (
                                      areaValue !== null &&
                                      areaValue !== undefined &&
                                      areaValue !== ""
                            ...
                            <div className="PaymentDetails-overlay-panel">
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      if (
                                        ...
                                        setFormTemplateData({
                                          recipient: formData.company_name,
                                          address1: formData.address,
                                          receiverEmail: formData.email,
                                          stateCity: `${formData.state}, ${formData.city}`,
                                          pincode: stall?.pin || formData.pin,
                                          senderState:
                              ...
                              {activePaymentDetailsOverlay === "stall" &&
                                ...
                                (() => {
                                  ...
                                  const totalPaidWithTDS = payments.reduce(
                                    (sum, pay) => {
                                  ...
                                  const grandTotal =
                                    stallList.length > 1
                                      ...
                                      : parseFloat(stall.grand_total || 0);
                                              ...
                                              {powerPayments.map(
                                                (pay, index) => (
                                                  <tr key={index}>
                                                    <td>{pay.type}</td>
                                                    <td>{pay.date}</td>
                                                    <td>{pay.exhibitorBank}</td>
                                                    <td>{pay.receiverBank}</td>
                                                    <td>{pay.amount}</td>
                                                    <td>{pay.tds}</td>
                                                    <td>
                                                      <button
                                  ...
                                  <div className="payment-billing-flex-wrapper">
                                    ...
                                    <div className="badgepayment-billing-details">
                                      ...
                                      <div className="exhibitor-billing-section">
                                        ...
                                        {parseInt(formData.extra_badges, 10) >
                                        0 ? (
                                          (() => {
                                            const {
                                              count,
                                  ...
                                  <div className="invoice-overlay-slide">
                                    ...
                                    >
                                      ...
                                      <div className="invoice-header-row">
                                          ...
                                          <div className="from-address">
                                            {activeAddress ? (
                                              <>
                                                ...
                                                <p>
                                                  Phone:{" "}
                                                  {activeAddress.data?.phone}
                                                </p>
                                                <p>
                                                  Email:{" "}
                                                  {activeAddress.data?.email}
                                                </p>
                                                <p>
                                                  GST: {activeAddress.data?.gst}
                                                </p>
                                              </>
                                            ) : (
                                              <p style={{ color: "red" }}>
                                        ...
                                        <div className="to-column">
                                          <div className="to-details">
                                            <p>
                                              M/S {formTemplateData.recipient}
                                            </p>
                                      ...
                                      <div className="bank-details">
                                        ...
                                        <div className="bank-row">
                                          <div className="bank-column">
                                            <p>
                                              <strong>A/C Name:</strong> RSD
                                              EXPOSITIONS
                                            </p>
                                            <p>
                                              <strong>Bank Name:</strong> Kotak
                                              Mahindra Bank
                                            </p>
                                            <p>
                                      ...
                                      <div className="invoice-footer">
                                        <p>
                                          <strong>
                                            ALL CHEQUES SHOULD BE SENT TO THE
                                            FOLLOWING ADDRESS
                                          </strong>
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                          <strong>
                                            THIS IS NOT AN INVOICE, THE FINAL
                                            TAX INVOICE WILL BE ISSUED LATER
                                          </strong>
                                        </p>
                                      </div>
                                    </div>
                        ...
                        <div className="facia-board-row">
                          <div className="facia-board-input-section">
                            ...
                            <input
                              ...
                              value={faciaText}
                              onChange={(e) => setFaciaText(e.target.value)}
                            />
                          </div>
...
export default ExhibitorsPanel;
